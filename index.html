...
<div id="wrapper">
  ...
  <div id="header">
    <div class="logo">
      <h1>The tree hills</h1>
      <p>Clean Simple Web Design Company</p>
    </div>
    <div class="nav">
      <ul>
        <li><a href="#">non trisque amet</a></li>
        <li><a href="#">morbi semper</a></li>
        <li><a href="#">hac habitasse</a></li>
      </ul>
    </div>
  </div>
  <!-- header starts here -->
  ...
  <div id="continertopbg">
    ...
    <div id="continerbottombg">
      ...
      <div id="continer">
        ...
        <div class="block1">
          <h1 class="head">Nam risus tortor, mattis ac sodales at, iaculis eget lorem.</h1>
  ...
  <div class="summryblock">
    ...
    <div class="innerwrapper">
      ...
      <div class="summryblock1">
        <h2>Vestibulum sed felis</h2>
        <p>Ut ipsum ultricies ultrices et id sem. Mauris ornare ante ut velit ultrices at condimentum ligula suscipit.</p>
      </div>
      <div class="summryblock2">
        <h2>Phasellus consequat </h2>
        <p>In sed dui eget augue interdum vestibulum. Quisque a tortor nisi, quis blandit nulla.</p>
      </div>
      <div class="summryblock3">
        <h2>Integer nec diam lacus </h2>
        <p>Ut sapien lacus, mollis facilisis ullamcorper et, vulputate non mauris. Maecenas sollicitudin iaculis cursus. </p>
      </div>
  ...
  <div class="blueContaner">
    ...
    <!-- inner wrapper ends here -->
      <br />
      <br />
      <div id="footer"><p style="color:black;">&#169; <a href="https://info.icopyright.net/" style="color:#4C0606">Copyright</a>. <script type="text/javascript">document.write(new Date().getFullYear());</script>. <a href="https://www.opensourcetemplates.org/index.html" style="color:#4C0606">Open Source Website Templates</a>. All Rights Reserved. <a href="https://www.opensourcetemplates.org/terms.html" style="color:#4C0606">Terms</a> | <a href="https://www.opensourcetemplates.org/sitemap.html" style="color:#4C0606">Site Map</a> | <a href="https://themeruler.com/" style="color:#4C0606">More Themes</a></p></div>
  </div>
  <!-- blue bg ends here -->
</div>
<!-- wrapper ends here -->
